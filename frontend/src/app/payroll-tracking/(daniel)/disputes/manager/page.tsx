...
const DisputesManagerPage: React.FC = () => {
  ...
  const handleApprove = async (dispute: Dispute) => {
    ...
    try {
      ...
      const response = await fetch(
        `${API_URL}/payroll-tracking/dispute/${dispute._id}/manager-confirm`,
        {
          method: "POST",
  ...
  const handleReject = async (dispute: Dispute) => {
    ...
    try {
      ...
      const response = await fetch(
        `${API_URL}/payroll-tracking/dispute/${dispute._id}/manager-reject`,
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          credentials: "include",
...
export default DisputesManagerPage;
